...
lowestMSE = 100000;
for current_batch_size in batchSizes:
# Use EarlyStopping callback to test a training condition to stop training when the validation score stops improving.
    ...
    history = model.fit(normTrainingData, train_labels, batch_size=current_batch_size, epochs=1500,
